...
void loadImageAssets() {
    if (iLoadImage(&img, "assets/images/wallpaper.bmp")) {
        // Loaded successfully
    } else {
        // Failed to load
    }
...
if (iLoadImage(&img1, "assets/images/level1.bmp")) {
        // Loaded successfully
    } else {
        // Failed to load
    }

    if (iLoadImage(&img2, "assets/images/level2.bmp")) {
        // Loaded successfully
    } else {
        // Failed to load
    }
    ...
    if (iLoadImage(&img3, "assets/images/level3.bmp")) {
        // Loaded successfully
    } else {
        // Failed to load
    }
